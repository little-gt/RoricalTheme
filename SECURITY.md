...
目前我们仅为以下版本提供安全更新，建议尽快升级至最新版本以确保安全性与稳定性。目前该主题已经彻底完成了对于 Typecho 1.2.1 和 1.3.0、 PHP 7.4-8.3 和 MySQL 9 的支持。并且完成了 Cookie 管理器的支持更新。

| Version | Status |
| :------ | :----- |
| **1.2.13**          | ✅ Latest           |
| **大于等于 1.2.12**   | ✅ Supported        |
| **低于版本 1.2.12**   | ❌ Out of Scope     |
